                    ...
                    if edit:
                         if event.button == 1:
                              ...
                              if brushObjSnapGrid.isSelected():
                                   ...
                                   room.AddObject(room.database[OBJTYPE].values()[brushObjList.getSelected()], view.camX+event.pos[0]-view.posX, view.camY+event.pos[1]-view.posY)
