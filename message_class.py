...
VIEW_SCROLLSTART          = VIEW_START+2
VIEW_SCROLLEND            = VIEW_START+3
VIEW_FADESTART            = VIEW_START+4
VIEW_FADEEND              = VIEW_START+5
VIEW_DRAW                 = VIEW_START+6
...
MSG_HOOK[VIEW_FADESTART]                 = "OnViewFadeStart"
MSG_HOOK[VIEW_FADEEND]                   = "OnViewFadeEnd"
